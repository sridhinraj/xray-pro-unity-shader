Shader "Custom/XRayClippingShader_Opaque"
{
    Properties
    {
        ...
        _DarkenFactor("Darken Factor", Range(0, 1)) = 0.0 // Add Darken Factor here
        _BrightnessFactor("Brightness Factor", Range(0, 2)) = 1.0 // Add Brightness Factor here
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _DarkenFactor; // Add Darken Factor variable
            float _BrightnessFactor; // Add Brightness Factor variable
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                // Light direction (assuming a directional light setup)
                ...
                // Apply darken effect
                finalColor *= (1.0 - _DarkenFactor); // Darkening effect based on the Darken Factor

                // Apply brightness effect
                finalColor *= _BrightnessFactor; // Brightening effect based on the Brightness Factor
